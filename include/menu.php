<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="../views/article/article_ajout.php"><img src="../photos/ajoutArticle.png" width="15vw" height="15vh"></img> Ajout Artcile</a></li>
			<li><a href="../views/facture/facture.php"><img src="../photos/facture.png" width="15vw" height="15vh"></img> Facture</a></li>
			<li><a href="../views/commande/commande_ajout.php"><img src="../photos/commande.png" width="15vw" height="15vh"></img> Commande</a></li>
			...
			<li class="parent ">
				<a href="../views/client/client_liste.php">
				...
				<ul class="children collapse" id="sub-item-1">
					<li>
						<a class="" href="../views/client/clientPhysique_liste.php">
							<img src="../photos/client.png" width="15vw" height="15vh"></img> Client physique
						</a>
					</li>
					<li>
						<a class="" href="../views/client/clientSociete_liste.php">
